 ...
 * @author eduarc
 */
public class AdaBoostConfigDialog extends ModelConfigDialog {

  AdaBoostConfigPanel panel;
  ClassifierFactory factory;
  
  public AdaBoostConfigDialog(ClassificationPanel cPanel) {
    super(cPanel);
    setTitle(ModelChooser.MODEL_NAME[ModelChooser.M_ADABOOST]);
    
    panel = new AdaBoostConfigPanel(cPanel);
  ...
  public int onOk() {
    ...
    factory = new AdaBoostFactory(bb, k);
